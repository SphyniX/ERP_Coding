--
-- @file    ui/message/lc_wndareamsg.lua
-- @authors zl
-- @date    2016-08-14 20:01:44
-- @desc    WNDAreaMsg
--
...
-- ##	UIMGR.WNDStack:pop()
	UIMGR.create_window("UI/WNDAreaSchedule")
end
...
local function on_subtop_subcontact_btnproject_click(btn)
...
local function init_view()
	...
	Ref.SubTop.SubContact.btnProject.onAction = on_subtop_subcontact_btnproject_click
