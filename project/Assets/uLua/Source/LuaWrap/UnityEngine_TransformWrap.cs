...
public class UnityEngine_TransformWrap
{
	...
	static int GetClassType(IntPtr L)
	{
		int count = L.GetTop();
		if (count == 0) {
			L.PushLightUserData(typeof(Transform));
			return 1;
		} else {
	...
	static int get_localEulerAngles(IntPtr L)
	{
		...
		L.PushUData(obj.localEulerAngles);
		return 1;
	}
	...
	static int get_parent(IntPtr L)
	{
		...
		L.PushLightUserData(obj.parent);
		return 1;
	}
	...
	static int get_worldToLocalMatrix(IntPtr L)
	{
		...
		L.PushLightUserData(obj.worldToLocalMatrix);
		return 1;
	}
	...
	static int get_localToWorldMatrix(IntPtr L)
	{
		...
		L.PushLightUserData(obj.localToWorldMatrix);
		return 1;
	}
	...
	static int set_localPosition(IntPtr L)
	{
		...
		obj.localPosition = L.ToVector3(3);
		return 0;
	}
	...
	static int set_localEulerAngles(IntPtr L)
	{
		...
		obj.localEulerAngles = L.ToVector3(3);
		return 0;
	}
	...
	static int set_localRotation(IntPtr L)
	{
		...
		obj.localRotation = L.ToQuaternion(3);
		return 0;
	}
	...
	static int set_parent(IntPtr L)
	{
		...
		obj.parent = L.ToComponent(3, typeof(UnityEngine.Transform)) as UnityEngine.Transform;
		return 0;
	}
	...
	static int SetParent(IntPtr L)
	{
		...
		if (count == 2)
		{
			Transform obj = (Transform)L.ChkUnityObjectSelf(1, "Transform");
			var arg0 = L.ToComponent(2, typeof(UnityEngine.Transform)) as UnityEngine.Transform;
			obj.SetParent(arg0);
			return 0;
		}
		else if (count == 3)
	...
	static int Translate(IntPtr L)
	{
		...
		else if (count == 3 && L.CheckTypes(1, typeof(Transform), typeof(LuaTable), typeof(Transform)))
		{
			Transform obj = (Transform)L.ChkUnityObjectSelf(1, "Transform");
			var arg0 = L.ToVector3(2);
			var arg1 = L.ToComponent(3, typeof(UnityEngine.Transform)) as UnityEngine.Transform;
			obj.Translate(arg0,arg1);
			return 0;
		}
		else if (count == 3 && L.CheckTypes(1, typeof(Transform), typeof(LuaTable), typeof(Space)))
		{
			Transform obj = (Transform)L.ChkUnityObjectSelf(1, "Transform");
			var arg0 = L.ToVector3(2);
			var arg1 = (Space)L.ChkEnumValue(3, typeof(Space));
			obj.Translate(arg0,arg1);
			return 0;
		}
		else if (count == 4)
		...
		else if (count == 5 && L.CheckTypes(1, typeof(Transform), typeof(float), typeof(float), typeof(float), typeof(Transform)))
		{
			Transform obj = (Transform)L.ChkUnityObjectSelf(1, "Transform");
			var arg0 = (float)L.ToNumber(2);
			var arg1 = (float)L.ToNumber(3);
			var arg2 = (float)L.ToNumber(4);
			var arg3 = L.ToComponent(5, typeof(UnityEngine.Transform)) as UnityEngine.Transform;
			obj.Translate(arg0,arg1,arg2,arg3);
			return 0;
		}
		else if (count == 5 && L.CheckTypes(1, typeof(Transform), typeof(float), typeof(float), typeof(float), typeof(Space)))
		{
			Transform obj = (Transform)L.ChkUnityObjectSelf(1, "Transform");
			var arg0 = (float)L.ToNumber(2);
			var arg1 = (float)L.ToNumber(3);
			var arg2 = (float)L.ToNumber(4);
			var arg3 = (Space)L.ChkEnumValue(5, typeof(Space));
			obj.Translate(arg0,arg1,arg2,arg3);
			return 0;
		}
		else
	...
	static int Rotate(IntPtr L)
	{
		...
		else if (count == 3 && L.CheckTypes(1, typeof(Transform), typeof(LuaTable), typeof(float)))
		{
			Transform obj = (Transform)L.ChkUnityObjectSelf(1, "Transform");
			var arg0 = L.ToVector3(2);
			var arg1 = (float)L.ToNumber(3);
		...
		else if (count == 4 && L.CheckTypes(1, typeof(Transform), typeof(LuaTable), typeof(float), typeof(Space)))
		{
			Transform obj = (Transform)L.ChkUnityObjectSelf(1, "Transform");
			var arg0 = L.ToVector3(2);
			var arg1 = (float)L.ToNumber(3);
			var arg2 = (Space)L.ChkEnumValue(4, typeof(Space));
			obj.Rotate(arg0,arg1,arg2);
			return 0;
		}
		else if (count == 4 && L.CheckTypes(1, typeof(Transform), typeof(float), typeof(float), typeof(float)))
		{
			Transform obj = (Transform)L.ChkUnityObjectSelf(1, "Transform");
			var arg0 = (float)L.ToNumber(2);
			var arg1 = (float)L.ToNumber(3);
	...
	static int LookAt(IntPtr L)
	{
		...
		if (count == 2 && L.CheckTypes(1, typeof(Transform), typeof(LuaTable)))
		{
			Transform obj = (Transform)L.ChkUnityObjectSelf(1, "Transform");
			var arg0 = L.ToVector3(2);
			obj.LookAt(arg0);
		...
		else if (count == 2 && L.CheckTypes(1, typeof(Transform), typeof(Transform)))
		{
			Transform obj = (Transform)L.ChkUnityObjectSelf(1, "Transform");
			var arg0 = L.ToComponent(2, typeof(UnityEngine.Transform)) as UnityEngine.Transform;
			obj.LookAt(arg0);
		...
		else if (count == 3 && L.CheckTypes(1, typeof(Transform), typeof(LuaTable), typeof(LuaTable)))
		{
			Transform obj = (Transform)L.ChkUnityObjectSelf(1, "Transform");
			var arg0 = L.ToVector3(2);
			var arg1 = L.ToVector3(3);
		...
		else if (count == 3 && L.CheckTypes(1, typeof(Transform), typeof(Transform), typeof(LuaTable)))
		{
			Transform obj = (Transform)L.ChkUnityObjectSelf(1, "Transform");
			var arg0 = L.ToComponent(2, typeof(UnityEngine.Transform)) as UnityEngine.Transform;
			var arg1 = L.ToVector3(3);
