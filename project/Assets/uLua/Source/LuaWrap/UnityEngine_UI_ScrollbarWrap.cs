...
public class UnityEngine_UI_ScrollbarWrap
{
	public static System.Type Register(IntPtr L)
	{
		...
		var type = typeof(UnityEngine.UI.Scrollbar);
	...
	static int GetClassType(IntPtr L)
	{
		int count = L.GetTop();
		if (count == 0) {
			L.PushLightUserData(typeof(UnityEngine.UI.Scrollbar));
			return 1;
		} else {
	...
	static int get_numberOfSteps(IntPtr L)
	{
		...
		L.PushInteger(obj.numberOfSteps);
		return 1;
	}
	...
	static int set_direction(IntPtr L)
	{
		...
		obj.direction = (UnityEngine.UI.Scrollbar.Direction)L.ChkEnumValue(3, typeof(UnityEngine.UI.Scrollbar.Direction));
		return 0;
	}
	...
	static int set_numberOfSteps(IntPtr L)
	{
		...
		obj.numberOfSteps = (int)L.ChkNumber(3);
		return 0;
	}
	...
	static int set_onValueChanged(IntPtr L)
	{
		...
		obj.onValueChanged = (UnityEngine.UI.Scrollbar.ScrollEvent)L.ChkUserData(3, typeof(UnityEngine.UI.Scrollbar.ScrollEvent));
		return 0;
	}
	...
	{
		L.ChkArgsCount(2);
		UnityEngine.UI.Scrollbar obj = (UnityEngine.UI.Scrollbar)L.ChkUnityObjectSelf(1, "UnityEngine.UI.Scrollbar");
	...
	static int SetDirection(IntPtr L)
	{
		L.ChkArgsCount(3);
		UnityEngine.UI.Scrollbar obj = (UnityEngine.UI.Scrollbar)L.ChkUnityObjectSelf(1, "UnityEngine.UI.Scrollbar");
		var arg0 = (UnityEngine.UI.Scrollbar.Direction)L.ChkEnumValue(2, typeof(UnityEngine.UI.Scrollbar.Direction));
