...
namespace ZFrame.UGUI
{
    ...
    public class UIProgressBar : UIBehaviour, ITweenable
    {
        ...
        [SerializeField]
        public Image m_PrevBar = null, m_FadeBar = null, m_CurrBar = null;
        ...
        protected void SetVisualImage(Image image, float visualValue)
        {
            ...
            if (image != null && image.type == Image.Type.Filled) {
                ...
                if (reverseValue)
                    anchorMin[(int)axis] = 1 - visualValue;
                else
                    anchorMax[(int)axis] = visualValue;
            }
